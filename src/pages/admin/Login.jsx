...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden flex-col justify-between p-12 text-white bg-indigo-600">
        {/* Background Patterns */}
        ...
        <div className="absolute -bottom-[20%] -right-[10%] w-[60%] h-[60%] rounded-full bg-indigo-900/40 blur-3xl pointer-events-none z-0"></div>
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-200 text-lg max-w-md font-light leading-relaxed">
            Manage candidate applications, review profiles, and streamline your hiring process securely from one centralized dashboard.
          </p>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <div className="flex items-center text-white/80">
            ...
            <span className="font-medium text-indigo-50">View and filter candidate applications instantly</span>
          </div>
          <div className="flex items-center text-white/80">
            <div className="bg-white/10 p-2 rounded-lg mr-4 shadow-sm border border-white/10">
              <Briefcase className="h-5 w-5 text-indigo-100" />
            </div>
            <span className="font-medium text-indigo-50">Export candidate data to Excel or PDF with one click</span>
          </div>
          <div className="flex items-center text-white/80">
            <div className="bg-white/10 p-2 rounded-lg mr-4 shadow-sm border border-white/10">
              <ShieldCheck className="h-5 w-5 text-indigo-100" />
            </div>
            <span className="font-medium text-indigo-50">Secure, authenticated access for authorized personnel</span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white relative z-10 shadow-[-20px_0_40px_rgb(0,0,0,0.05)]">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-12 rounded-xl border-slate-200 transition-all bg-slate-50/50 focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20"
              />
            </div>
            ...
            <Button
              type="submit"
              className="w-full h-12 rounded-xl text-base font-semibold transition-all mt-4 text-white shadow-lg bg-indigo-600 hover:bg-indigo-700 shadow-indigo-600/20"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-12 text-center text-sm text-slate-400">
            ...
            <p>&copy; {new Date().getFullYear()} DropyHub Recruitment Portal</p>
          </div>
        </div>
      </div>
    </div>
